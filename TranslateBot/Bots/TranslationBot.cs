...
namespace TranslateBot.Bots
{
	...
	internal class TranslationBot : ActivityHandler
	{
		...
		protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
		{
			...
			const string infoText = "Translating...";    // TODO: При отправки кириллицы в канал текст отображается некорректно. Есть мнение, что это из-за кодировки проекта (?) или кодировки хостинга, на котором опубликовано приложение бота.
